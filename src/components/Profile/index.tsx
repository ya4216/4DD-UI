            ...
            <Form className="login__create">
              ...
              {!successful && (
                <div className="login__inputs">
                  ...
                  <div
                    style={{ lineHeight: 0 }}
                    className={isChangePassword ? 'mb-10' : ''}
                  >
                    <button type="submit" className="login__button">
                      <p
                        className={
                          isChangePassword
                            ? 'button-text password_on'
                            : 'button-text password_off'
                        }
                        onClick={() => {
                  ...
                  {isChangePassword && (
                    <div>
                      ...
                      <div>
                        <button
                          type="submit"
                          className="btn btn-primary btn-block login__button"
                        >
